...
// 배열 요소의 총 갯수
console.log(friends.length); // 9

// 배열 요소 변경
friends[0] = '선범';
console.log(friends); // ['선범', ' 혜미', ' 송이', ' 효윤', ' 선용', ' 승민', ' 상호', ' 영은', ' 희소']


// 배열 요소 추가
let unshift = friends.unshift('진승');
console.log(friends); // ['진승', '선범', ' 혜미', ' 송이', ' 효윤', ' 선용', ' 승민', ' 상호', ' 영은', ' 희소']

let push = friends.push('동균');
console.log(friends); // ['진승', '선범', ' 혜미', ' 송이', ' 효윤', ' 선용', ' 승민', ' 상호', ' 영은', ' 희소', '동균']
